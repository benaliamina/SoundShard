 ...
 * This file demonstrates how to integrate Soundshard with a web frontend
 */

// For React/Vue/Angular applications
export class SoundshardClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SoundshardClient(provider, contractAddress);
